# Times1 Message Extension Bot - `times1MessageExtensionBot`
...
3. Give the bot a handle (ex: `times1MessageExtensionBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://times1.azurewebsites.net/api/messages`
