...
@PreventIframe("/times1MessageExtension/config.html")
@PreventIframe("/times1MessageExtension/action.html")
export default class Times1MessageExtension implements IMessagingExtensionMiddlewareProcessor {
    ...
    public async onFetchTask(context: TurnContext, value: IMessagingExtensionActionRequest): Promise<MessagingExtensionResult | ITaskModuleResult> {
        ...
        return Promise.resolve<ITaskModuleResult>({
            ...
            value: {
                title: "Input form",
                url: `https://${process.env.HOSTNAME}/times1MessageExtension/action.html`
            }
        });
